...
const COURSE_DEFS = [
  {
    ...
    description: "IFRS accounting standards (IFRS 15, IFRS 9, IAS 2, IFRS 16, IAS 37) and physical commodity trading, worked through African coal and sulphur markets.",
    intro: "Commodity trading and IFRS reporting are usually taught separately, which is how a contract gets negotiated on commercial instinct and then produces an accounting treatment nobody saw coming. This course covers both sides at once: how physical trades are structured, priced and financed, and how IFRS 15, IFRS 9, IAS 2, IFRS 16 and IAS 37 apply to them. The worked examples come from real African coal and sulphur trades.",
  ...
  },
  {
    ...
    description: "Open Finance and Open Banking essentials: the UAE CBUAE framework, Nebras API Hub, FDX standards, OAuth 2.0 and FAPI security, and the use cases they enable.",
    intro: "Open Finance hands control of banking data to the customer, who can let a third party into their accounts. Banks have to build for that rather than around it. The course starts with why the model exists, then works through the UAE's CBUAE framework and the Nebras API Hub, the API and security standards behind them, and what consent and data protection demand day to day. It closes on the commercial side: which use cases and business models the framework opens up.",
