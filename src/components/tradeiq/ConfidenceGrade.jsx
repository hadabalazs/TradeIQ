...
export default function ConfidenceGrade({ value, onSelect }) {
  const options = [
      ...
      <div className="flex gap-2">
        {options.map(({ grade, label, icon: Icon, hint }) => (
          <button
            ...
            className={`flex-1 flex flex-col items-center gap-1 px-3 py-2 rounded-lg border text-xs font-medium transition ${
              value === grade
