...
export default function CourseContentManager() {
  // All published courses, not just the ones downloaded to this device.
      ...
      {(courses || []).length === 0 ? (
        ...
        <ul className="space-y-2">
          {courses.map((course) => {
            ...
            // Question counts need the full course body, which a course that has
            // not been downloaded does not have loaded yet.
